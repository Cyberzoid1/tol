...
This timeline is a rough estimate of each weeks tasks that will be completed to finish our Tower of Lights application. 
	...
	\begin{tikzpicture}
		...
		\draw (0,0)  node[below=3pt] {\footnotesize$(10/26-11/2)$} node[above=3pt] {\tiny$Rough Design Spec.$};
		\draw (2,0)  node[below=3pt] {\footnotesize$(11/2 - 11/9)$} node[above=3pt] {\tiny$Finish Design Spec.$};
		\draw (4,0)  node[below=3pt] {\footnotesize$(11/9 - 11/16)$} node[above=3pt] {\tiny$Create GUI$};
		\draw (6,0)  node[below=3pt] {\footnotesize$(11/16 - 11/23)$} node[above=3pt] {\tiny$Some Core funct.$};
		\draw (8,0)  node[below=3pt] {\footnotesize$(11/23 - 11/30)$} node[above=3pt] {\tiny$All core funct.$};
		\draw (10,0)  node[below=3pt] {\footnotesize$(11/30 - 12/7)$} node[above=3pt] {\tiny$Add features$};
		\draw (12,0)  node[below=3pt] {\footnotesize$(12/7 - 12/14)$} node[above=3pt] {\tiny$Add features$};
	\end{tikzpicture}
